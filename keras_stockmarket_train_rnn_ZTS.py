...
training_set = pd.read_csv('ZTS_stock.csv')
...
x_train = training_set[0:980]
y_train = training_set[1:981]

# Reshaping
x_train = np.reshape(x_train, (98, 10, 1))
y_train = np.reshape(y_train, (98, 10, 1))
...
for i in range(10):
    ...
    model.save('LSTM2_stockmarket_ZTS_' + str((epochs * i + 500)) + '.h5py') 
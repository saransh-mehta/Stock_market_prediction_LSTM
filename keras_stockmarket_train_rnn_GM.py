...
x_train = training_set[0:1540]
y_train = training_set[1:1541]

# Reshaping
x_train = np.reshape(x_train, (154, 10, 1))
y_train = np.reshape(y_train, (154, 10, 1))
...
for i in range(10):
    ...
    model.save('LSTM2_stockmarket_GM_' + str((epochs * i + 500)) + '.h5') 